...
class Iso10BandEqView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (isLocked) {
            lockBadgePaint.color = if (isEink) Color.BLACK else Color.parseColor("#F59E0B")
            canvas.drawText("LOCKED 🔒", width - 8f * density, 14f * density, lockBadgePaint)
        }
    }
